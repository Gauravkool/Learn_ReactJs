...
function CurrencyApp() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('https://images.pexels.com/photos/462331/pexels-photo-462331.jpeg?auto=compress&cs=tinysrgb&w=600')`,
      }}
    >
        ...
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          ...
          >
            ...
            <div className="relative w-full h-0.5">
              <button
                type="button"
                className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-md bg-blue-600 hover:bg-blue-500 text-white px-2 py-0.5"
                onClick={swap}
              >
                swap
              </button>
